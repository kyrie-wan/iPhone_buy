...
var iPhoneQiang = {
	insertFloating : function () {
		var floatingHTml = '<style>.qFloating{position:fixed; bottom:0px;right:0px;border:#ddd solid 1px;width:600px;height:800px; background-color:#fff;}.qFloating label {display: inline-block;margin-bottom: 5px;font-weight: bold;}.form-group {margin-bottom: 15px; }.form-control {display: block;width: 100%;height: 34px;padding: 6px 12px;font-size: 14px;line-height: 1.428571429;color: #555555;vertical-align: middle;background-color: #ffffff;border: 1px solid #cccccc;border-radius: 4px;-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);-webkit-transition: border-color ease-in-out 0.15s, box-shadow ease-in-out 0.15s;transition: border-color ease-in-out 0.15s, box-shadow ease-in-out 0.15s;}</style><div class="qFloating"><div class="form-group">\
